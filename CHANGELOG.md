...
### Changed
- **Language Switcher**: Reordered languages to prioritize key markets: ES, EN, IT, FR, DE, PT, followed by others.
...
### Changed
- **UI/UX**: Refined hover states for dark buttons. Instead of simple opacity, buttons now lighten to `#34373C` on hover to provide clear "clickable" feedback (accent) without reverting to the brand yellow, as requested.
