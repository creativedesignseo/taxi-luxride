  ...
  return (
    <div className="bg-white rounded-2xl p-6 shadow-lg border border-[rgba(3,2,19,0.05)] mt-8 md:hidden">
      ...
      <div className="space-y-4">
        ...
        <button 
          onClick={onBooking}
          className="w-full bg-[#1C1F23] text-white py-4 rounded-xl font-bold hover:bg-[#34373C] transition-all flex items-center justify-center gap-2 font-['Inter',sans-serif] mt-2 shadow-md"
        >
          Ver Tarifas
        </button>
      </div>
